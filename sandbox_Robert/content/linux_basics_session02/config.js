...
export const config = {
	...
	init: `
	        mkdir -p bank
		mkdir -p bank/bos_taurus bank/homo_sapiens bank/nr;
		PREFIX=bank/bos_taurus/UMD3.1;
		...
		mkdir -p $HOME/test;
   		...
   		mkdir -p /root/tutorial/linux_basics_session02/projects/; # IFB-sandbox.bio
	`,
	files: [],
};
