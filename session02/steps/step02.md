...
```bash
/shared/data/tutorials/ifb-2/bank/homo_sapiens
```
...
```bash
ls /shared/data/tutorials/ifb-2/bank/homo_sapiens
```
...
<Quiz id="q1" choices={[ 
	...
	<span slot="prompt">
    What does the command `ls /shared/data/tutorials/ifb-2/bank/homo_sapiens` return? 
	</span>
</Quiz>  
